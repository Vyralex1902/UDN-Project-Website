       ...
       text-white">
        ...
        <div id="sectionContainer" className="items-center text-center h-[100vh]">
          <div id="sectionDiv" className="flex flex-col items-center mb-10">
            ...
            <p className="text-sm max-w-[500px] text-cyan-400 text-center">
              sep2023-now
            </p>
          </div>
          <div id="sectionDiv" className="flex flex-col items-center mb-10">
          ...
          <div id="sectionDiv" className="flex flex-col items-center mb-10">
            <PiNumberFour className="w-14 h-auto text-white" />
          ...
          <div id="sectionDiv" className="flex flex-col items-center mb-10">
            <PiNumberFive className="w-14 h-auto text-white" />
          ...
          <div id="sectionDiv" className="flex flex-col items-center">
            <PiNumberSix className="w-14 h-auto text-white" />
